<div class="form-group">
    ...
    <div class="input-group date" data-provide="datepicker" data-date-language="cs">
        <input type="text" class="form-control <?php echo isset($error) ? 'is-invalid' : '' ?>" id="form-control-<?php echo $name; ?>" name="<?php echo $name; ?>" <?php if ($value) { ?> value="<?php p(dateTxt($value)) ?>" <?php } ?>>
